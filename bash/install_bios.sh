...
dd if=/dev/zero of=bios.img bs=1G count=8
parted -s bios.img mklabel msdos
parted -s bios.img print
parted -s bios.img mkpart primary ext4 0% 100%
parted -s bios.img print

LO="$(sudo losetup --find --partscan --show bios.img)"
