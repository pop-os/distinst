...
impl<'a> DiskOps<'a> {
    ...
    /// generated
    pub fn remove(self) -> Result<ChangePartitions<'a>, DiskError> {
        info!(
...
impl<'a> ChangePartitions<'a> {
    ...
    /// modified.
    pub fn change(self) -> Result<CreatePartitions<'a>, DiskError> {
        info!(
...
impl<'a> CreatePartitions<'a> {
    ...
    pub fn create(mut self) -> Result<FormatPartitions, DiskError> {
        info!(
